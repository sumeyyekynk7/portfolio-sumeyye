      ...
      <div className="container-shell">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-2">
          {projects.map((project, index) => (
            ...
            >
              <div className="flex h-44 items-end bg-gradient-to-br from-slate-900 via-surface to-sky-950 p-5">
                <div className="w-full rounded-xl border border-white/10 bg-white/[0.06] p-4 shadow-sm backdrop-blur">
